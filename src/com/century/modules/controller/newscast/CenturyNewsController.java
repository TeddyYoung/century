 ...
 */
@Controller
@RequestMapping(value = "/modules/century/news")
public class CenturyNewsController extends JsonBaseController{
	...
	protected String getView(String view) {
		return "/modules/century/news/"+view;
	}
	...
	public Message create(@ModelAttribute CenturyNewscast centuryNewscast) {
		centuryNewscast.setNewsType("1");
		centuryNewscastService.save(centuryNewscast);
