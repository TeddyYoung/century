...
<html lang="en">
	...
	<body class="no-skin">
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="pull-right">
									<%-- <shiro:hasPermission name="modules:ne:category:query">
										<button class="btn btn-sm btn-info" id="query">查询</button>
									</shiro:hasPermission> --%>
									<shiro:hasPermission name="modules:ne:category:edit">
										<button class="btn btn-sm btn-default" id="edit">修改</button>
									</shiro:hasPermission>
									<shiro:hasPermission name="modules:ne:category:create">
										<button class="btn btn-sm btn-warning" id="createBas">新增</button>
									</shiro:hasPermission>
									<shiro:hasPermission name="modules:ne:category:delete">
										<button class="btn btn-sm btn-danger" id="delete">删除</button>
									</shiro:hasPermission>
									<shiro:hasPermission name="modules:ne:category:excel">
		...
		<script type="text/javascript">
			//基本路径
			var baseUrl = "<s:url value="/modules/ne/category"></s:url>/"
			
			//jqgrid的表格高度
			var height = 320;
			//jqgrid表格行头的中文
			var colNames = ['','大类编号', '名称','编号'];
			//jqgrid表格中每一行的信息模型
			var colModel = [
				{name:'sysId', width:60, hidden: true,key:true},
				{name:'claId',index:'claId', width:60, hidden: true,},
			...
			//具体查询方法
			function query() {
				seachJqgird("#categoryGridTable","#formDialog form");
