		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<form:form cssClass="form-horizontal" commandName="centuryNewscast" onsubmit="return false;"
								...
								<div class="form-group">
									...
									<label class="col-sm-2 control-label no-padding-right"
										for="category">栏目</label>
									<div class="col-sm-4">
											
											<form:select path="category" items="${redis:getDictList('Category',false)}" itemValue="name" itemLabel="name" cssClass="form-control"></form:select>
 ...
 $("#save").click(function(){
 	...
 	if($("#newsFrom").valid()) {
 						...
 						postCallBack({
 							...
 							url:'<s:url value="/modules/century/news/edit"></s:url>',
							successMessage: "更新成功",
							successTitle: "消息对话框",
							failMessage: "更新失败",
							failTitle: "消息对话框"
