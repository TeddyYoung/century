							...
							<form:form cssClass="form-horizontal" commandName="centuryNewscast" onsubmit="return false;"
								...
								<div class="form-group">
									...
									<label class="col-sm-2 control-label no-padding-right"
										for="title">栏目</label>
									<div class="col-sm-4">
										<form:select path="category" items="${redis:getDictList('Category',false)}" itemValue="basId" itemLabel="name" cssClass="form-control"></form:select>
				...
				.click(
						function() {
							...
							if ($("#newsFrom").valid()) {
								...
								window.parent
										.openapp(
												'<s:url value="/modules/century/news"/>',
												'CeNews', '新闻管理');
								var appid = "newsCreate";
								window.parent.closeapp($(
										"#task-content li[app-id='" + appid
												+ "']", parent.document));
