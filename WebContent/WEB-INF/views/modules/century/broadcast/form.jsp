						...
						<div class="col-xs-12">
							...
							<form class="form-horizontal" role="form">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea id="container">${activity.content }</textarea>
									</div>
								</div>
 ...
 $("#save").click(function(){
 	...
 	if($("#broadcastFrom").valid()) {
 						...
 						postCallBack({
 							...
 							url:'<s:url value="/modules/century/broadcast/create"></s:url>',
							successMessage: "更新成功",
							successTitle: "消息对话框",
							failMessage: "更新失败",
							failTitle: "消息对话框"
 						});		
 					window.parent.openapp('<s:url value="/modules/century/broadcast"/>', 'broadcast', '新闻管理');			
 					var appid = "broadcastCreate";
