...
<div class="col-xs-12">	
	<form:form commandName="sysBasFilter" cssClass="form-horizontal" role="form">
		<div class="form-group">
			<label class="col-sm-2 control-label no-padding-right" for="name">大类编号</label>
			<div class="col-sm-3">
				<input type="text" name="claId" id="claId" placeholder="请输入大类名称" value="${sysBasFilter.claId }" class="form-control">
			</div>
