...
<form:form commandName="sysBas" cssClass="form-horizontal" role="form">
	<div class="form-group">
		...
		<div class="col-sm-3">
			<input type="text" name="claId" id="claId" placeholder="请输入大类编号" value="${sysBas.claId}" class="form-control required" <c:if test="${!sysBas.modflag }">readonly</c:if>>
		</div>
		
		<label class="col-sm-1 control-label no-padding-right" for="basId">小类编号</label>
		<div class="col-sm-3">
			<input type="text" name="basId" id="basId" placeholder="请输入小类编号" value="${sysBas.basId}" class="form-control required" <c:if test="${!sysBas.modflag }">readonly</c:if>>
		</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-3">
			<label  class="control-label">
				<input type="checkbox" name="delflag" class="ace ace-switch ace-switch-3" <c:if test="${sysBas.delflag }">checked</c:if>>
				<span class="lbl"></span>
			</label>
		</div>
		...
		<div class="col-sm-3">
			<label class="control-label">
				<input type="checkbox" name="modflag" class="ace ace-switch ace-switch-3" <c:if test="${sysBas.modflag }">checked</c:if>>
				<span class="lbl"></span>
			</label>
		</div>
