...
<form:form commandName="sysBas" cssClass="form-horizontal" role="form">
	<div class="form-group">
		...
		<div class="col-sm-3">
			<input type="text" name="claId" id="claId" placeholder="请输入大类编号" value="${sysBas.claId}" class="form-control required">
		</div>
		
		<label class="col-sm-1 control-label no-padding-right" for="basId">小类编号</label>
		<div class="col-sm-3">
			<input type="text" name="basId" id="basId" placeholder="请输入小类编号" value="${sysBas.basId}" class="form-control required" readonly="readonly">
		</div>
